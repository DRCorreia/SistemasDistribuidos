...
def imprime_cliente (nome=None):
        conn = mysql.connector.connect (host='sistemasdistribuidos.c9aa3shrbfs3.us-east-1.rds.amazonaws.com', user='admin', passwd='mariojoao', port='3306', database='chinook')
        cursor = conn.cursor()
